...
const UserList = () => {
    ...
    return (
        <>
            <Text align={'center'} fontSize="xxx-large" pt={5} fontWeight="bold" fontFamily="serif" color="#27A9E1">Ajackus User Management Dashboard</Text>
            <Flex justifyContent="center">
                <Button textColor={'black'} colorScheme="#27A9E1" onClick={() => openModal()} mt={10} border={"1px solid teal"}>Add New User</Button>
            </Flex>
            ...
            <Flex justify="center"mt={-10} mb={5}>
                <Text fontWeight="600" mx={4} pt={2} color={'black'}>{currentPage} / {totalPages}</Text>
            </Flex>
            <br></br>
            <Flex justify="center"mt={-10} mb={5}>
                <Text fontWeight="600" mx={4} pt={2} color={'#27A9E1'}>Assignment by Dushyant Kumar </Text>
            </Flex>
            {isModalOpen && (
                <UserModal
                    isOpen={isModalOpen}
